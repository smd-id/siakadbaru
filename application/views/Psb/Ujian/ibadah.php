                            ...
                            <form id="form_wawancara" method="post" class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="doa_seharihari" id="doa_seharihari" required>
                                                <option value="">Pilih</option>
                                                <option value="1">SANGAT BAIK</option>
                                                <option value="2">BAIK</option>
                                                <option value="3">CUKUP</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="keterangan_ibadah" id="keterangan_ibadah" rows="4" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
