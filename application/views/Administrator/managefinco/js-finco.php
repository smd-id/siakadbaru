...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('managefinco/ajax_edit/') ?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function delete_data(id)
{
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url : "<?php echo site_url('managefinco/ajax_delete') ?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?=base_url('managefinco/ajax_add')?>";
    } else {
        url = "<?=base_url('managefinco/ajax_update')?>";
    }
