...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('managerole/ajax_edit/') ?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="role_color"]').val(data.role_color);
...
function delete_data(id)
{
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url : "<?php echo site_url('managerole/ajax_delete') ?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?=base_url('managerole/ajax_add')?>";
    } else {
        url = "<?=base_url('managerole/ajax_update')?>";
    }
